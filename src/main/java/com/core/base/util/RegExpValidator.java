...
public final class RegExpValidator {
	...
	public static boolean isVehicleNum(String str) {
		String regex = "^[\u4e00-\u9fa5][A-Z](?:\\-|\\.)?[A-Z0-9]{5}$|^WJ[0-9]{2}(?:\\-|\\.)?(?:[\u4e00-\u9fa5]|[A-Z0-9])[A-Z0-9]{4}$"; 
	 ...
	 * @param str 待验证的字符串
	 * @param min 最小值
	 * @return 如果是符合要求的字符串,返回 <b>true </b>,否则为 <b>false </b>
	 */
	 ...
	 * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
	 */
	public static boolean IsLetterAndComma(String str) {
