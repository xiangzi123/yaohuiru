...
<div class="rightSide">
    ...
    <div class="content" id="main-content">
    	<div class="sear" id="query_form"> 
            ...
            <label>类型名称：<input type="text"  id="communityTypeName"/></label> 

         
             <label><input type="button" value="查询" class="butt" onclick="query()"/></label>
        </div>
        <div class="toolBar">&nbsp;
            <input type="button" value="新增" class="new auth" authKey = "communityType_add" onclick="addcommunityTypeIn();"/>
           
        </div>
			<table id="communityTypeList"></table>
		<div id="communityTypeListPager"></div>
  	 	</div>
	    <div class="bottom">
	    	<div class="left"></div>
	...
	<script type="text/javascript" src="<%=templatePath%>js/system/system_communitytype_main.js"></script>
