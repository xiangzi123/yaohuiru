...
<div class="rightSide">
    ...
    <div class="content" id="main-content">
    	<div class="sear" id="query_form"> 
            ...
            <label>客户姓名：<input type="text"  id="customerName"/></label> 
            <label>身份证号：<input type="text"  id="idcard"/></label> 
             <label><input type="button" value="查询" class="butt" onclick="query()"/></label>
        </div>
        <div class="toolBar">&nbsp;
            <input type="button" value="新增" class="new auth" authKey = "customer_add" onclick="addcustomerIn();"/>
	...
	<script type="text/javascript" src="<%=templatePath%>js/system/system_customer_main.js"></script>
