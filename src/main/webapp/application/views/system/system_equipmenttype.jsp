...
<div class="rightSide">
    ...
    <div class="content" id="main-content">
    	<div class="sear" id="query_form"> 
            ...
            <label>设施名称：<input type="text"  id="equipmentTypeName"/></label> 

         
             <label><input type="button" value="查询" class="butt" onclick="query()"/></label>
        </div>
        <div class="toolBar">&nbsp;
            <input type="button" value="新增" class="new auth" authKey = "equipmentType_add" onclick="addequipmentTypeIn();"/>
           
        </div>
			<table id="equipmentTypeList"></table>
		<div id="equipmentTypeListPager"></div>
  	 	</div>
	    <div class="bottom">
	    	<div class="left"></div>
	...
	<script type="text/javascript" src="<%=templatePath%>js/system/system_equipmenttype_main.js"></script>
