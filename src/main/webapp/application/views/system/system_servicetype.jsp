...
<div class="rightSide">
    ...
    <div class="content" id="main-content">
        ...
        <div class="toolBar">&nbsp;
            <input type="button" value="新增" class="new auth" authKey = "serviceType_add" onclick="addserviceTypeIn();"/>
           
        </div>
			<table id="serviceTypeList"></table>
		<div id="serviceTypeListPager"></div>
  	 	</div>
	    <div class="bottom">
	    	<div class="left"></div>
	...
	<script type="text/javascript" src="<%=templatePath%>js/system/system_servicetype_main.js"></script>
